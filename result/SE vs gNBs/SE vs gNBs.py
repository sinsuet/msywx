...
QMIX = [19.2778, 26.555, 33.2503]
GDFP = [20.1525, 26.9849, 33.6218]
# Randompolicy = [33.9825, 34.035, 34.0551]



# MARL_values = [22.6703, 29.9913, 36.3809]
# DQN_values = [20.5441, 27.6412, 34.1219]
# QMIX = [19.1342, 26.5848, 32.3622]
# GDFP = [20.1525, 26.9849, 33.6218]
...
# --- 9. 保存并显示图像 ---
plt.savefig('../SE vs gNBs/SE vs gNBs.png')
plt.show()
